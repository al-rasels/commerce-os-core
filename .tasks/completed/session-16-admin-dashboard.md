...
- [x] Dashboard page with metric cards:
  - [x] Total revenue (today, this week, this month)
  - [x] Order count (pending, processing, completed)
  - [x] New customers
  - [x] Low-stock products warning
- [x] Revenue chart (line/bar, filterable by period)
- [x] Recent orders list (last 10, quick status update)
- [x] Top-selling products list
- [x] Quick action buttons (new product, view orders)

## Acceptance Criteria

- [x] Dashboard loads with real data from API
- [x] Revenue chart renders correctly for selected period
- [x] Low-stock warning appears when stock < threshold
- [x] Metrics are tenant-scoped
- [x] Dashboard is performant (<1s load time)
