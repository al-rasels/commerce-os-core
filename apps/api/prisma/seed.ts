  ...
  await prisma.templateBase.create({
    data: {
      ...
      layout_json: {
        ...
        page_layouts: {
          homepage: [
            { type: 'announcement_bar', props: { text: 'Free shipping on orders over $150 — Extended returns through January', bgColor: '#1f2937', textColor: '#ffffff' } },
            { type: 'hero_banner', props: { title: 'Winter Edition 2026', subtitle: 'Where elegance meets edge. Discover our coldest-weather collection yet.', cta: 'Explore the Collection', ctaLink: '/collections/winter-2026', bgImage: '/assets/hero-winter.jpg', bgColor: '#b91c1c', overlay: true, height: '90vh', alignment: 'left', badge: 'New Season' } },
            { type: 'value_props_strip', props: { items: [{ icon: 'truck', text: 'Free Shipping over $150' }, { icon: 'refresh', text: '60-Day Easy Returns' }, { icon: 'shield', text: 'Secure Checkout' }, { icon: 'gift', text: 'Complimentary Gift Wrap' }], bgColor: '#ffffff' } },
            { type: 'featured_categories', props: { title: 'Shop by Category', subtitle: 'Curated for every moment', count: 4, layout: 'card_grid', imageAspect: '3:4' } },
            { type: 'featured_products', props: { title: 'Trending Now', subtitle: 'Most-loved styles this season', count: 6, layout: 'horizontal_scroll', badge: 'Hot' } },
            { type: 'banner_divider', props: { title: 'Up to 40% Off', subtitle: 'Limited-time markdowns on select styles', cta: 'Shop Sale', ctaLink: '/category/sale', bgColor: '#7f1d1d', textColor: '#ffffff', layout: 'full_width' } },
            { type: 'featured_products', props: { title: 'The Studio Edit', subtitle: 'Work-to-weekend staples curated by our team', count: 4, layout: 'grid_2x2', badge: 'Editor Pick' } },
            { type: 'testimonial_carousel', props: { title: 'What Our Clients Say', testimonials: [{ name: 'Sophie L.', text: 'The quality is unmatched. Every piece feels intentional and thoughtfully designed.', rating: 5, location: 'New York, NY' }, { name: 'James K.', text: 'Finally, a brand that understands modern tailoring. Perfect fit every time.', rating: 5, location: 'London, UK' }, { name: 'Aisha R.', text: 'Their customer service is as impeccable as their clothing. Truly a luxury experience.', rating: 5, location: 'Dubai, UAE' }], bgColor: '#fef2f2' } },
            { type: 'brand_story', props: { title: 'Our Craft', body: 'Every stitch tells a story. From our atelier in Milan to your wardrobe, each piece is a collaboration between master artisans and forward-thinking design.', cta: 'Read Our Story', image: '/assets/about-cover.jpg' } },
            { type: 'instagram_feed', props: { title: '@RunwayWear', subtitle: 'Tag us for a chance to be featured', count: 6, bgColor: '#ffffff' } },
            { type: 'newsletter', props: { title: 'Become an Insider', subtitle: 'Join our community. Get 10% off your first order plus early access to new drops and exclusive edits.', bgColor: '#b91c1c', textColor: '#ffffff', placeholder: 'Enter your email', cta: 'Subscribe' } },
          ],
          products: [
            { type: 'breadcrumbs', props: { homeLabel: 'Home', separator: '/' } },
            { type: 'search_bar', props: { placeholder: 'Search by product, category, or brand...', autocomplete: true } },
            { type: 'active_filters', props: { showClearAll: true } },
            { type: 'category_filter', props: { layout: 'grid', showCounts: true, sortOptions: ['Newest', 'Price: Low to High', 'Price: High to Low', 'Best Selling', 'Rating'] } },
            { type: 'product_grid', props: { columns: 3, tabletColumns: 2, mobileColumns: 1, pagination: 24, infiniteScroll: false, lazyLoad: true, showQuickAdd: true } },
          ],
          product_detail: [
            { type: 'breadcrumbs', props: { homeLabel: 'Home', separator: '/' } },
            { type: 'product_gallery', props: { layout: 'thumbnails_stacked', zoom: true, showThumbnails: true, thumbnailPosition: 'left' } },
            { type: 'product_info', props: { showReviews: true, showSku: true, showStockLevel: true, showSizeGuide: true, showWishlist: true, showShare: true } },
            { type: 'accordion_sections', props: { items: [{ title: 'Details & Fit', content: 'Multi-season weight, true to size, model is 5\'10" wearing size S' }, { title: 'Materials & Care', content: '100% organic cotton shell, machine wash cold, tumble dry low' }, { title: 'Shipping & Returns', content: 'Free shipping over $150. 60-day return window. Final sale items excluded.' }] } },
            { type: 'cross_sell', props: { title: 'Complete the Look', strategy: 'completes_the_outfit', count: 3 } },
            { type: 'related_products', props: { title: 'You May Also Like', strategy: 'category_based', count: 4, layout: 'horizontal_scroll' } },
            { type: 'recently_viewed', props: { title: 'Recently Viewed', count: 4, layout: 'horizontal_scroll' } },
          ],
        },
        sample_products: [
          {
  ...
  await prisma.templateBase.create({
    data: {
      ...
      layout_json: {
        ...
        page_layouts: {
          homepage: [
            { type: 'announcement_bar', props: { text: 'Free 2-Day Shipping on orders $50+ | 0% APR Financing for 12 Months on select items', bgColor: '#0f172a', textColor: '#ffffff' } },
            { type: 'hero_banner', props: { title: 'Next-Gen Power. Unveiled.', subtitle: 'The new AuraBook Pro M4 is here. Up to 22hr battery life, 3x faster neural engine, and a breathtaking Liquid Retina XDR display.', cta: 'Pre-Order Now', ctaSecondary: 'Compare Models', bgColor: '#1e40af', badge: 'Just Released', height: '85vh', alignment: 'left' } },
            { type: 'value_props_strip', props: { items: [{ icon: 'truck', text: 'Free 2-Day Shipping' }, { icon: 'rotate', text: '30-Day Returns, No Questions' }, { icon: 'shield', text: '2-Year Warranty Included' }, { icon: 'headset', text: '24/7 Tech Support' }, { icon: 'tag', text: 'Price Match Guarantee' }], bgColor: '#f8fafc', borderBottom: true } },
            { type: 'featured_categories', props: { title: 'Shop by Category', subtitle: 'Explore our extensive catalog', count: 5, layout: 'icon_grid', columns: 5 } },
            { type: 'deal_of_the_day', props: { title: 'Deal of the Day', count: 3, showTimer: true, badge: 'Limited Offer', bgColor: '#ffffff' } },
            { type: 'featured_products', props: { title: 'Top Rated', subtitle: 'By customers, for customers', count: 6, layout: 'grid_3x2', badge: '★ Top Rated', sortBy: 'rating' } },
            { type: 'banner_divider', props: { title: 'Save up to $300 on Trade-In', subtitle: 'Get instant credit toward your next upgrade. Eligible on laptops, phones, and tablets.', cta: 'Get Your Quote', bgColor: '#1e3a8a', textColor: '#ffffff', layout: 'split', image: '/assets/trade-in-banner.jpg' } },
            { type: 'brand_logo_strip', props: { title: 'Top Brands', logos: ['Apple', 'Samsung', 'Sony', 'Bose', 'Dell', 'LG', 'AMD', 'Intel'], bgColor: '#ffffff' } },
            { type: 'featured_products', props: { title: 'New Arrivals', subtitle: 'The latest tech, freshly stocked', count: 4, layout: 'horizontal_scroll', badge: 'New' } },
            { type: 'testimonial_carousel', props: { title: 'Trusted by Millions', testimonials: [{ name: 'Marcus J.', text: 'Best tech shopping experience hands down. The price match saved me $150 and support was incredible.', rating: 5, location: 'Austin, TX', verifiedPurchase: true }, { name: 'Priya K.', text: 'The financing options made my home studio setup affordable. Will be a lifelong customer.', rating: 5, location: 'Toronto, CA', verifiedPurchase: true }, { name: 'Carlos M.', text: 'Shipping was incredibly fast — ordered my laptop at 10am and it arrived the next morning.', rating: 5, location: 'Miami, FL', verifiedPurchase: true }] } },
            { type: 'service_promises', props: { items: [{ icon: 'wrench', title: 'Geek Squad Support', text: 'Expert setup, repair, and advisory services' }, { icon: 'calendar', title: 'Flexible Financing', text: '0% APR for 12 months on orders $299+' }, { icon: 'award', title: 'Certified Refurbished', text: 'Factory-tested, full warranty, up to 30% off' }], columns: 3 } },
            { type: 'newsletter', props: { title: 'Stay Ahead of the Curve', subtitle: 'Get exclusive access to member-only deals, early product drops, and tech insights.', bgColor: '#1e40af', textColor: '#ffffff', placeholder: 'Enter your email address', cta: 'Subscribe' } },
          ],
          products: [
            { type: 'breadcrumbs', props: { homeLabel: 'Home', showCategory: true } },
            { type: 'search_bar', props: { placeholder: 'Search 10,000+ products by name, brand, or SKU...', autocomplete: true, voiceSearch: true } },
            { type: 'active_filters', props: { showClearAll: true, showCount: true } },
            { type: 'category_filter', props: { layout: 'sidebar', showCounts: true, sortOptions: ['Best Match', 'Price: Low to High', 'Price: High to Low', 'Customer Rating', 'Newest', 'Most Reviews'], filters: ['Brand', 'Price Range', 'Rating', 'Availability', 'Discount'] } },
            { type: 'compare_toolbar', props: { enabled: true, maxCompare: 4 } },
            { type: 'product_grid', props: { columns: 4, tabletColumns: 3, mobileColumns: 2, pagination: 24, infiniteScroll: false, showCompare: true, showRating: true, quickView: true } },
          ],
          product_detail: [
            { type: 'breadcrumbs', props: { showCategory: true, showProductName: true } },
            { type: 'product_gallery', props: { layout: 'thumbnails_column', zoom: true, imageCount: 5, showVideo: true, has360View: true } },
            { type: 'product_info', props: { showSpecs: true, showSku: true, showStockLevel: true, showReviews: true, showWarranty: true, showFinancing: true } },
            { type: 'accordion_sections', props: { items: [
            ...
            { type: 'comparison_table', props: { title: 'Compare Models', models: ['Base', 'Pro', 'Max'], attributes: ['Processor', 'RAM', 'Storage', 'Display', 'Battery'] } },
            { type: 'cross_sell', props: { title: 'Frequently Bought Together', strategy: 'frequently_bundled', count: 4, showTotal: true } },
            { type: 'related_products', props: { title: 'Customers Also Viewed', strategy: 'views_affinity', count: 6, layout: 'horizontal_scroll' } },
            { type: 'recently_viewed', props: { title: 'Recently Viewed', count: 4, layout: 'grid_2x2' } },
          ],
        },
        sample_products: [
          {
  ...
  await prisma.templateBase.create({
    data: {
      ...
      layout_json: {
        ...
        page_layouts: {
          homepage: [
            { type: 'announcement_bar', props: { text: 'Free store pickup | Save 5% with RedCard | Weekly deals end Sunday', bgColor: '#4f46e5', textColor: '#ffffff' } },
            { type: 'hero_banner', props: { title: 'Spring Refresh Sale', subtitle: 'Save up to 30% on home, fashion & outdoor — plus an extra 10% with code SPRING10', cta: 'Shop the Sale', ctaSecondary: 'Shop New Arrivals', bgColor: '#4f46e5', badge: 'Up to 30% Off', height: '75vh', alignment: 'center' } },
            { type: 'value_props_strip', props: { items: [{ icon: 'truck', text: 'Free Shipping $35+' }, { icon: 'store', text: 'Free Same-Day Pickup' }, { icon: 'rotate', text: '90-Day Easy Returns' }, { icon: 'credit-card', text: 'Save 5% w/ RedCard' }], bgColor: '#ffffff' } },
            { type: 'deal_grid', props: { title: 'Today\'s Deals', subtitle: 'Limited-time offers updated daily', items: [{ text: 'Buy 2 Get 1 Free', desc: 'On all home decor' }, { text: '30% Off', desc: 'Select outdoor gear' }, { text: 'Spend $50, Save $10', desc: 'Beauty & personal care' }], columns: 3 } },
            { type: 'featured_categories', props: { title: 'Shop by Department', subtitle: 'Find exactly what you need', count: 6, layout: 'card_grid', columns: 3 } },
            { type: 'featured_products', props: { title: 'Bestsellers', subtitle: 'What everyone is buying right now', count: 8, layout: 'grid_4x2', badge: 'Bestseller' } },
            { type: 'banner_divider', props: { title: 'Weekly Ad', subtitle: 'New deals every Wednesday. Clip coupons, stack savings, and shop the best prices of the week.', cta: 'View Weekly Ad', bgColor: '#4338ca', textColor: '#ffffff', layout: 'full_width' } },
            { type: 'featured_products', props: { title: 'New Arrivals', subtitle: 'Fresh finds for every room', count: 4, layout: 'horizontal_scroll', badge: 'New' } },
            { type: 'brand_story', props: { title: 'Why Shop With Us', body: 'From everyday essentials to special finds, we bring you quality products at prices that make sense. Free shipping, easy returns, and a team that cares.', cta: 'Learn More', image: '/assets/about-store.jpg', layout: 'compact' } },
            { type: 'testimonial_carousel', props: { title: 'Loved by Shoppers', testimonials: [{ name: 'Maria G.', text: 'This is my go-to for everything. The prices are great and pickup is always ready within 2 hours.', rating: 5, location: 'Chicago, IL' }, { name: 'David T.', text: 'The RedCard savings alone make it worth it. Fast shipping, easy app, and great customer service.', rating: 5, location: 'Seattle, WA' }, { name: 'Nancy P.', text: 'I love the product selection and the quality exceeds what I expect for the price point.', rating: 5, location: 'Atlanta, GA' }], bgColor: '#f9fafb' } },
            { type: 'service_promises', props: { items: [{ icon: 'target', title: 'Order Pickup', text: 'Free same-day pickup at 2,000+ stores' }, { icon: 'gift', title: 'Gift Registry', text: 'Create a registry for any occasion' }, { icon: 'tag', title: 'Price Match', text: 'We match competitor prices on qualifying items' }], columns: 3, bgColor: '#ffffff' } },
            { type: 'newsletter', props: { title: 'Get More from Your Cart', subtitle: 'Sign up for weekly deals, personalized picks, and insider access. Plus, get 15% off your next order.', bgColor: '#4f46e5', textColor: '#ffffff', placeholder: 'Your email address', cta: 'Get 15% Off' } },
          ],
          products: [
            { type: 'breadcrumbs', props: { homeLabel: 'Home', separator: '›' } },
            { type: 'search_bar', props: { placeholder: 'Search thousands of products...', autocomplete: true } },
            { type: 'active_filters', props: { showClearAll: true, showCount: true } },
            { type: 'category_filter', props: { layout: 'sidebar', showCounts: true, sortOptions: ['Best Match', 'Price Low - High', 'Price High - Low', 'Top Rated', 'Newest', 'Percent Off'], filters: ['Category', 'Price', 'Brand', 'Rating', 'Color', 'Size', 'Availability', 'Discount'] } },
            { type: 'promo_bar', props: { text: 'Free shipping on orders $35+ | Spend $75 and get a free gift' } },
            { type: 'product_grid', props: { columns: 4, tabletColumns: 3, mobileColumns: 2, pagination: 24, infiniteScroll: true, showRating: true, quickView: true } },
          ],
          product_detail: [
            { type: 'breadcrumbs', props: { showCategory: true, showProductName: true } },
            { type: 'product_gallery', props: { layout: 'thumbnails_bottom', zoom: true, imageCount: 4 } },
            { type: 'product_info', props: { showReviews: true, showSku: true, showStockLevel: true, showWishlist: true, showRegistry: true } },
            { type: 'accordion_sections', props: { items: [
            ...
            { type: 'cross_sell', props: { title: 'Frequently Bought Together', strategy: 'frequently_bundled', count: 3, showSavings: true } },
            { type: 'related_products', props: { title: 'Customers Also Viewed', strategy: 'views_affinity', count: 6, layout: 'horizontal_scroll' } },
            { type: 'recently_viewed', props: { title: 'Recently Viewed', count: 4, layout: 'horizontal_scroll' } },
          ],
        },
