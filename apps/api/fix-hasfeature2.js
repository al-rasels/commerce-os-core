...
for(const file of files) {
  ...
  content = content.replace(/storagePrefix: 'tenantA',/g, "storagePrefix: 'tenantA',\n      hasFeature: () => false,");
  content = content.replace(/storagePrefix: 'tenantB',/g, "storagePrefix: 'tenantB',\n      hasFeature: () => false,");
  fs.writeFileSync(file, content);
}
console.log('Fixed hasFeature properly');
