# Node Description Batch 43 of 51
...
- "src_app_module_appmodule": "AppModule" | kind=code-symbol | source=apps/api/src/app.module.ts:L47 | neighbors=[app.module.ts]
- "src_app_protectedroute": "ProtectedRoute()" | kind=code-symbol | source=apps/admin/src/App.tsx:L33 | neighbors=[App.tsx]
- "src_app_service_appservice_gethello": ".getHello()" | kind=code-symbol | source=apps/api/src/app.service.ts:L5 | neighbors=[AppService]
- "src_main_bootstrap": "bootstrap()" | kind=code-symbol | source=apps/api/src/main.ts:L9 | neighbors=[main.ts]
...
to: D:\Rasel Mahmud Shanto\commerce-os-core\.graphify\description-instructions\batch-042.json
