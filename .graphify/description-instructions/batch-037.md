...
- "pages_loginpage_loginpage": "LoginPage()" | kind=code-symbol | source=apps/admin/src/pages/LoginPage.tsx:L11 | neighbors=[LoginPage.tsx]
...
- "payments_payments_service_paymentsservice_initiaterefund": ".initiateRefund()" | kind=code-symbol | source=apps/api/src/modules/commerce/payments/payments.service.ts:L51 | neighbors=[PaymentsService]
